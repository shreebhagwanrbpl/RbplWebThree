...
export async function fetchFullCatalog() {
  ...
  catalogPromise = (async () => {
    ...
    try {
      ...
      console.log("Category Count:", categorySnap.size);
      const allProducts = [];
...
export async function fetchHomeData() {
  return fetchDocCached("websites/globalbiomedicalorg/pages/home");
}

export async function fetchContactData() {
  return fetchDocCached("websites/globalbiomedicalorg/pages/contact");
}

export async function fetchServicesData() {
  return fetchDocCached("websites/globalbiomedicalorg/pages/services");
}

export async function fetchDistrictData(district) {
  if (!district) return null;
  return fetchDocCached(`websites/globalbiomedicalorg/districts/${district}`);
}
